...
class TestRorschach(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_rorschach(today_date,last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
...
class TestThovex(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_thovex(today_date, last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
